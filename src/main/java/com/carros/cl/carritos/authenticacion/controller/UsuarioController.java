...
import com.carros.cl.carritos.authenticacion.service.UsuarioService;
...
public class UsuarioController {
     ...
     */
    @PutMapping("/{id}/rol")
    public ResponseEntity<?> cambiarRol(HttpServletRequest request, @PathVariable Long id, @RequestBody Rol nuevoRol) {
        Claims claims = (Claims) request.getAttribute("claims");
